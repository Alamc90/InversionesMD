...
/* Mobile dialog: full-screen on small devices */
@media (max-width: 767px) {
  ...
  /* Make all table cells more compact on mobile */
  td, th {
...
.animate-fade-in-delayed {
  animation: fade-in-delayed 1s ease-out both;
}
...
@media (min-width: 1024px) {
  ...
  .lg\:grid-cols-\[minmax\(0\2c 1fr\)_minmax\(0\2c 1\.1fr\)_minmax\(0\2c 1\.4fr\)\] {
